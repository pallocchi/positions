...
public class ImportServiceTest {
    ...
    public void importShouldSavePositions() {
        ...
        when(repository.existsByExternalId(position.getExternalId())).thenReturn(false);
    ...
    @Test
    public void importWithExistingExternalIdShouldSkipPosition() {
        ...
        when(repository.existsByExternalId(position.getExternalId())).thenReturn(true);
